<%@ Page Language="C#" AutoEventWireup="true" CodeFile="doCredit.aspx.cs" Inherits="doCredit" %>
        ...
        <div>
            <div>
                <div style="text-align: center">
                    ...
                    <h2>
                        <span style="color: #5f5f5f; font-family: Arial">Do credit</span></h2>
                    ...
                    <p>
                        ...
                        <strong><span style="color: #5f5f5f;">Returned results</span></strong><span
                            style="color: #ff6600"> </span></span>
                    </p>
                    <p>
                        <span style="font-family: Arial">Return transaction date: </span>
                                <asp:TextBox ID="TextBoxTransactionDate" runat="server" ReadOnly="True" Width="189px"></asp:TextBox><br />
                        <span style="font-family: Arial">
                                Return transaction ID: </span>
                                <asp:TextBox ID="TextBoxReturnedID" runat="server" ReadOnly="True" Width="201px"></asp:TextBox></p>
                    <hr style="font-family: Arial" />
                    <p>
                                <table style="width: 842px; text-align: center; font-family: Arial;">
                                    <tr>
                                        <td style="width: 435px; height: 21px; text-align: left">
                                            <span style="color: #97cb00"><strong>I<span style="color: #97cb00">n</span>formation
                                                about transaction</strong></span></td>
                                        <td style="width: 638px; height: 21px">
                                        </td>
                                        <td style="width: 638px; height: 21px">
                                        </td>
                                    ...
                                    <tr style="color: #000000">
                                        ...
                                        <td style="width: 638px; height: 21px">
                                            <asp:DropDownList ID="DropDownListPaymentFunction" runat="server" Width="374px">
                                                <asp:ListItem Value="422">Credit</asp:ListItem>
                                            </asp:DropDownList></td>
                                        <td style="width: 638px; height: 21px; text-align: left">
                                            (Required)</td>
                                    </tr>
                                    <tr style="font-weight: bold; color: #000000">
                                        ...
                                        <td style="width: 638px; height: 21px; text-align: left; font-weight: normal;">
                                            (Required)</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 435px; height: 21px; text-align: left">
                                    ...
                                    <tr>
                                        <td style="width: 435px; height: 21px; text-align: left">
                                            <span style="color: #97cb00"><strong>Information about card:</strong></span></td>
                                        <td style="width: 638px; height: 21px; color: #000000;">
                                        </td>
                                        <td style="width: 638px; height: 21px; color: #000000;">
                                        </td>
                    ...
                    <p>
                        <span style="color: #ff6600"><span style="font-family: Arial">&nbsp;</span><asp:Button ID="ButtonDoCredit" runat="server" OnClick="ButtonDoPayment_Click" Text="Do credit" /><span
