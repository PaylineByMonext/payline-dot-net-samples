<%@ Page Language="C#" AutoEventWireup="true" CodeFile="doCapture.aspx.cs" Inherits="doCapture" %>
    ...
    <div>
        <div>
            <div style="text-align: center">
                ...
                <h2>
                    <span style="color: #5f5f5f; font-family: Arial">Do capture</span></h2>
                ...
                <p>
                    <span style="color: #ff6600"><span style="font-family: Arial">&nbsp;</span><table style="width: 698px; text-align: center; font-family: Arial;">
                                <tr>
                ...
                <hr style="font-family: Arial" />
                <p>
                    <span style="font-family: Arial">&nbsp;<strong><span style="color: #5f5f5f">Returned
                        results</span></strong></span></p>
                <p>
                    <span style="font-family: Arial">Return transaction date: </span>
                            <asp:TextBox ID="TextBoxTransactionDate" runat="server" ReadOnly="True" Width="223px"></asp:TextBox><br />
                    <span style="font-family: Arial">Return transaction ID: </span>
                            <asp:TextBox ID="TextBoxReturnedID" runat="server" ReadOnly="True" Width="233px"></asp:TextBox></p>
                <hr style="font-family: Arial" />
                <p>
                            <table style="width: 834px; text-align: center; font-family: Arial;">
                                <tr>
                                    <td style="width: 435px; height: 21px; text-align: left">
                ...
                <p>
                    <span style="color: #ff6600">
                            <asp:Button ID="ButtonDoCapture" runat="server" OnClick="ButtonDoPayment_Click" Text="Do capture" /><span
                                style="font-family: Arial"> &nbsp;</span></span><span style="font-family: Arial">&nbsp;</span></p>
            </div>
        </div>
